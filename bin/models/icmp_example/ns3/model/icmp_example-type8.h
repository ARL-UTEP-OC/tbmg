#ifndef ICMP_EXAMPLE_TYPE_0_H
#define ICMP_EXAMPLE_TYPE_0_H
...
namespace ns3 {
/**
 * \ingroup icmp_exampleType0
 * \brief 
 *
 * Note: 
 */
class icmp_exampleType0 : public icmp_examplePacketType
{
public:
   ...
   */
  icmp_exampleType0 (/* any input parameters, these are all optional */);
  virtual ~icmp_exampleType0 ();
