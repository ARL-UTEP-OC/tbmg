...
NS_LOG_COMPONENT_DEFINE ("whb_icmp-type0");

int
whb_icmpType0::GetTypeId (void)
{
...
unsigned char 
whb_icmpType0::get_icmp_type_34()
{
  
  return icmp_type_34;
}
void whb_icmpType0::set_icmp_type_34(unsigned char val)
{
  
  icmp_type_34 = val;
}
unsigned char 
whb_icmpType0::get_icmp_code_35()
{
  
  return icmp_code_35;
}
void whb_icmpType0::set_icmp_code_35(unsigned char val)
{
  
  icmp_code_35 = val;
}
uint16_t
whb_icmpType0::get_icmp_checksum_36()
{
  
  return icmp_checksum_36;
}
void whb_icmpType0::set_icmp_checksum_36(uint16_t val)
{
  
  icmp_checksum_36 = val;
}
uint16_t
whb_icmpType0::get_icmp_ident_38()
{
  
  return icmp_ident_38;
}
void whb_icmpType0::set_icmp_ident_38(uint16_t val)
{
  
  icmp_ident_38 = val;
}
uint16_t
whb_icmpType0::get_icmp_seq_40()
{
  
  return icmp_seq_40;
}
void whb_icmpType0::set_icmp_seq_40(uint16_t val)
{
  
  icmp_seq_40 = val;
}
uint64_t
whb_icmpType0::get_icmp_data_time_42()
{
  
  return icmp_data_time_42;
}
void whb_icmpType0::set_icmp_data_time_42(uint64_t val)
{
  
  icmp_data_time_42 = val;
}
unsigned char* whb_icmpType0::get_data_data_50()
{
  
  return data_data_50;
}
void whb_icmpType0::set_data_data_50(unsigned char* val)
{
...
/**
 * create a whb_icmpType0
 */

whb_icmpType0::whb_icmpType0 ()//(/* any input parameters, these are all optional */);
{
  //set default values
...
whb_icmpType0::~whb_icmpType0 ()
{
  
}
  
float
whb_icmpType0::isPacketType(unsigned char *candidate, int size)
{
  //HERE!
...
void
whb_icmpType0::Write32 (uint8_t *buffer, const uint32_t data)
{
...
// of data is at lowest buffer address
void
whb_icmpType0::Write16 (uint8_t *buffer, const uint16_t data)
{
  NS_LOG_FUNCTION (this << buffer << data);
...
// of data is at lowest buffer address
void
whb_icmpType0::Write64 (uint8_t *buffer, uint64_t data)
{
  NS_LOG_FUNCTION (this << buffer << data);
...
void
whb_icmpType0::Read16 (const uint8_t *buffer, uint16_t &data)
{
  NS_LOG_FUNCTION (this << buffer << data);
...
// Read data from a little-endian formatted buffer to data
void
whb_icmpType0::Read32 (const uint8_t *buffer, uint32_t &data)
{
  NS_LOG_FUNCTION (this << buffer << data);
...
// Read data from a little-endian formatted buffer to data
void
whb_icmpType0::Read64 (const uint8_t *buffer, uint64_t &data)
{
...
Ptr<Packet> whb_icmpType0::getPacket()
{
  uint8_t sendData[64];
...
void whb_icmpType0::DoDispose (void)
{
