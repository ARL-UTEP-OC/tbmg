...
- iptables
"""
#https://github.com/mike01/pypacker/blob/python27/pypacker/interceptor.py
...
try:
	...
	pass#logger.warning(MSG_NO_NFQUEUE)
...
class Interceptor(object):
	...
	def verdict_trigger_cycler(recv, nfq_handle, obj):
		try:
			...
			pass  #logger.debug("Exception while reading: %r", ex)
		#finally:
