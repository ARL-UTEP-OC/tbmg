		...
		<packet>
			<xsl:attribute name="nodeuniq">
				<xsl:value-of select="concat(
                    'ip-src=', proto/field[@name='ip.src']/@value, ';',
                    'ip-dst=', proto/field[@name='ip.dst']/@value, ';',
                    'mac-src=', proto/field[@name='eth.src']/@value, ';',
                    'mac-dst=', proto/field[@name='eth.dst']/@value, ';',
                    'protoName=icmp')"/>
		    </xsl:attribute>
