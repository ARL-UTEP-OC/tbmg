...
NS_LOG_COMPONENT_DEFINE ("icmp_example-PacketType");

// Writes data to buffer in little-endian format; least significant byte
// of data is at lowest buffer address
void
icmp_examplePacketType::Write32 (uint8_t *buffer, const uint32_t data)
{
...
// of data is at lowest buffer address
void
icmp_examplePacketType::Write16 (uint8_t *buffer, const uint16_t data)
{
  NS_LOG_FUNCTION (this << buffer << data);
...
// of data is at lowest buffer address
void
icmp_examplePacketType::Write64 (uint8_t *buffer, uint64_t data)
{
  NS_LOG_FUNCTION (this << buffer << data);
...
void
icmp_examplePacketType::Read16 (const uint8_t *buffer, uint16_t &data)
{
  NS_LOG_FUNCTION (this << buffer << data);
...
// Writes data from a little-endian formatted buffer to data
void
icmp_examplePacketType::Read32 (const uint8_t *buffer, uint32_t &data)
{
  NS_LOG_FUNCTION (this << buffer << data);
...
// Writes data from a little-endian formatted buffer to data
void
icmp_examplePacketType::Read64 (const uint8_t *buffer, uint64_t &data)
{
