...
NS_LOG_COMPONENT_DEFINE ("icmp_example-type1");

int
icmp_exampleType1::GetTypeId (void)
{
...
unsigned char 
icmp_exampleType1::get_icmp_type_34()
{
  
  return icmp_type_34;
}
void icmp_exampleType1::set_icmp_type_34(unsigned char val)
{
  
  icmp_type_34 = val;
}
unsigned char 
icmp_exampleType1::get_icmp_code_35()
{
  
  return icmp_code_35;
}
void icmp_exampleType1::set_icmp_code_35(unsigned char val)
{
  
  icmp_code_35 = val;
}
uint16_t
icmp_exampleType1::get_icmp_checksum_36()
{
  
  return icmp_checksum_36;
}
void icmp_exampleType1::set_icmp_checksum_36(uint16_t val)
{
  
  icmp_checksum_36 = val;
}
uint16_t
icmp_exampleType1::get_icmp_ident_38()
{
  
  return icmp_ident_38;
}
void icmp_exampleType1::set_icmp_ident_38(uint16_t val)
{
  
  icmp_ident_38 = val;
}
uint16_t
icmp_exampleType1::get_icmp_seq_40()
{
  
  return icmp_seq_40;
}
void icmp_exampleType1::set_icmp_seq_40(uint16_t val)
{
  
  icmp_seq_40 = val;
}
uint64_t
icmp_exampleType1::get_icmp_data_time_42()
{
  
  return icmp_data_time_42;
}
void icmp_exampleType1::set_icmp_data_time_42(uint64_t val)
{
  
  icmp_data_time_42 = val;
}
unsigned char* icmp_exampleType1::get_data_data_50()
{
  
  return data_data_50;
}
void icmp_exampleType1::set_data_data_50(unsigned char* val)
{
...
/**
 * create a icmp_exampleType1
 */

icmp_exampleType1::icmp_exampleType1 ()//(/* any input parameters, these are all optional */);
{
  //set default values
  icmp_type_34 = 0x00;//ENTROPY: 0.0
  icmp_code_35 = 0x00;//ENTROPY: 0.0
  icmp_checksum_36 = 0x77e9;//ENTROPY: 1.0 , see xml for other values
...
icmp_exampleType1::~icmp_exampleType1 ()
{
  
}
  
float
icmp_exampleType1::isPacketType(unsigned char *candidate, int size)
{
  //HERE!
...
void
icmp_exampleType1::Write32 (uint8_t *buffer, const uint32_t data)
{
...
// of data is at lowest buffer address
void
icmp_exampleType1::Write16 (uint8_t *buffer, const uint16_t data)
{
  NS_LOG_FUNCTION (this << buffer << data);
...
// of data is at lowest buffer address
void
icmp_exampleType1::Write64 (uint8_t *buffer, uint64_t data)
{
  NS_LOG_FUNCTION (this << buffer << data);
...
void
icmp_exampleType1::Read16 (const uint8_t *buffer, uint16_t &data)
{
  NS_LOG_FUNCTION (this << buffer << data);
...
// Read data from a little-endian formatted buffer to data
void
icmp_exampleType1::Read32 (const uint8_t *buffer, uint32_t &data)
{
  NS_LOG_FUNCTION (this << buffer << data);
...
// Read data from a little-endian formatted buffer to data
void
icmp_exampleType1::Read64 (const uint8_t *buffer, uint64_t &data)
{
...
Ptr<Packet> icmp_exampleType1::getPacket()
{
  uint8_t sendData[64];
...
void icmp_exampleType1::DoDispose (void)
{
