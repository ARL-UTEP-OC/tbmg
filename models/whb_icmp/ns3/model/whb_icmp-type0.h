#ifndef WHB_ICMP_TYPE_1_H
#define WHB_ICMP_TYPE_1_H
...
namespace ns3 {
/**
 * \ingroup whb_icmpType1
 * \brief 
 *
 * Note: 
 */
class whb_icmpType1 : public whb_icmpPacketType
{
public:
   ...
   */
  whb_icmpType1 (/* any input parameters, these are all optional */);
  virtual ~whb_icmpType1 ();
